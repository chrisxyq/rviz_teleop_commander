...
{
    printf("creatting UartPBUTTING\n");

    bytDevType=0x3B;
    bytDevInfo=0x3B;
}

int UartPBUTTING::ReadDevInfo(unsigned char  acData[],string &strErr){
    strErr="";
    int nLen;
    int nSendLen;
    int nRcvLen;
...
int UartPBUTTING::ReadVersion(unsigned char  acData[],string &strErr){
    strErr="";
    int nLen;
    int nSendLen;
    int nRcvLen;
...
int UartPBUTTING::Reboot(unsigned char  acData[],string &strErr){
    strErr="";
    int nLen;
    int nSendLen;
    int nRcvLen;
...
int UartPBUTTING::ReadStatus(unsigned char  acData[],string &strErr){
    strErr="";
    int nLen;
    int nSendLen;
    int nRcvLen;
    const int nSendLenEx=8;
    const int nRcvLenEx=13;
    char acSendBuf[8];
    char acRcvBuf[13];
    unsigned short wCRC;
    unsigned int nBufStartIndex;
