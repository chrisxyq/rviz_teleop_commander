// Generated by gencpp from file N_Robot/OFPS1_ReadPosition_srvRequest.msg
// DO NOT EDIT!


#ifndef N_ROBOT_MESSAGE_OFPS1_READPOSITION_SRVREQUEST_H
#define N_ROBOT_MESSAGE_OFPS1_READPOSITION_SRVREQUEST_H
...
std::ostream& operator<<(std::ostream& s, const ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::N_Robot::OFPS1_ReadPosition_srvRequest_<ContainerAllocator>&)
  {}
};
...
#endif // N_ROBOT_MESSAGE_OFPS1_READPOSITION_SRVREQUEST_H
