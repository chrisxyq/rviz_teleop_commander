// Generated by gencpp from file navigator_q2/PathFinder_msg.msg
// DO NOT EDIT!


#ifndef NAVIGATOR_Q2_MESSAGE_PATHFINDER_MSG_H
#define NAVIGATOR_Q2_MESSAGE_PATHFINDER_MSG_H
...
struct PathFinder_msg_
{
  ...
  typedef boost::shared_ptr< ::navigator_q2::PathFinder_msg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::navigator_q2::PathFinder_msg_<ContainerAllocator> const> ConstPtr;

}; // struct PathFinder_msg_

typedef ::navigator_q2::PathFinder_msg_<std::allocator<void> > PathFinder_msg;

typedef boost::shared_ptr< ::navigator_q2::PathFinder_msg > PathFinder_msgPtr;
typedef boost::shared_ptr< ::navigator_q2::PathFinder_msg const> PathFinder_msgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::navigator_q2::PathFinder_msg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::navigator_q2::PathFinder_msg_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::navigator_q2::PathFinder_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::navigator_q2::PathFinder_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::navigator_q2::PathFinder_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::navigator_q2::PathFinder_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::navigator_q2::PathFinder_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::navigator_q2::PathFinder_msg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::navigator_q2::PathFinder_msg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::navigator_q2::PathFinder_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa0b961ff8f78bddeULL;
  static const uint64_t static_value2 = 0x7ce47c9a5aab32e2ULL;
};

template<class ContainerAllocator>
struct DataType< ::navigator_q2::PathFinder_msg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "navigator_q2/PathFinder_msg";
  }
...
template<class ContainerAllocator>
struct Definition< ::navigator_q2::PathFinder_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::navigator_q2::PathFinder_msg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::navigator_q2::PathFinder_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::navigator_q2::PathFinder_msg_<ContainerAllocator>& v)
  {
    s << indent << "bValid: ";
...
#endif // NAVIGATOR_Q2_MESSAGE_PATHFINDER_MSG_H
