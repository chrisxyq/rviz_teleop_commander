...
{ 
  ...
  // QGroupBox *jstate_GroupBox = new QGroupBox(QString::fromUtf8("关节状态"));
  ...
  // QGroupBox *endpos_GroupBox = new QGroupBox(QString::fromUtf8("末端位置"));
  ...
  // three_GroupBox_layout->addWidget(jstate_GroupBox);
  // three_GroupBox_layout->addWidget(endpos_GroupBox);
  // three_GroupBox_layout->addWidget(quaternion_GroupBox);

  // QHBoxLayout* widget1_layout = new QHBoxLayout;
  // widget1_layout->addLayout(paraset_GroupBox_layout);
  // widget1_layout->addLayout(jstate_GroupBox_layout);
  // widget1_layout->addLayout(three_GroupBox_layout);
  // widget1->setLayout(widget1_layout);
  widget1->setLayout(paraset_GroupBox_layout);
...
//   QHBoxLayout* H_para_layout4_1 = new QHBoxLayout;
//   QHBoxLayout* H_para_layout4_2 = new QHBoxLayout;
//   QHBoxLayout* H_para_layout4_3 = new QHBoxLayout;
//   QHBoxLayout* H_para_layout4_4 = new QHBoxLayout;
//   QHBoxLayout* H_para_layout4_5 = new QHBoxLayout;
//   QHBoxLayout* H_para_layout4_6 = new QHBoxLayout;
...
//   //H_para_layout4_1->addWidget( new QLabel( "Joint 1:" ));
//   H_para_layout4_1->addWidget( new QLabel( QString::fromUtf8("关节1") ));
//   H_para_layout4_1->addWidget(j1state);
//   H_para_layout4_1->addWidget( new QLabel( "X:" ));
//   H_para_layout4_1->addWidget(Xstate);  
...
//   //H_para_layout4_2->addWidget( new QLabel( "Joint 2:" ));
//   H_para_layout4_2->addWidget( new QLabel( QString::fromUtf8("关节2") ));
//   H_para_layout4_2->addWidget(j2state);
//   H_para_layout4_2->addWidget( new QLabel( "Y:" ));
//   H_para_layout4_2->addWidget(Ystate); 
...
//   //H_para_layout4_3->addWidget( new QLabel( "Joint 3:" ));
//   H_para_layout4_3->addWidget( new QLabel( QString::fromUtf8("关节3") ));
//   H_para_layout4_3->addWidget(j3state);
//   H_para_layout4_3->addWidget( new QLabel( "Z:" ));
//   H_para_layout4_3->addWidget(Zstate); 
...
//   //H_para_layout4_4->addWidget( new QLabel( "Joint 4:" ));
//   H_para_layout4_4->addWidget( new QLabel( QString::fromUtf8("关节4") ));
//   H_para_layout4_4->addWidget(j4state);
//   H_para_layout4_4->addWidget( new QLabel( "R:" ));
//   H_para_layout4_4->addWidget(RXstate); 
...
//   //H_para_layout4_5->addWidget( new QLabel( "Joint 5:" ));
//   H_para_layout4_5->addWidget( new QLabel( QString::fromUtf8("关节5") ));
//   H_para_layout4_5->addWidget(j5state);
//   H_para_layout4_5->addWidget( new QLabel( "P:" ));
//   H_para_layout4_5->addWidget(RYstate); 
//   // 第6行
...
//   //H_para_layout4_6->addWidget( new QLabel( "Joint 6:" ));
//   H_para_layout4_6->addWidget( new QLabel( QString::fromUtf8("关节6") ));
//   H_para_layout4_6->addWidget(j6state);
//   H_para_layout4_6->addWidget( new QLabel( "Y:" ));
//   H_para_layout4_6->addWidget(RZstate); 


//   ArmState_layout->addLayout(H_para_layout4_1 );
//   ArmState_layout->addLayout(H_para_layout4_2 );
//   ArmState_layout->addLayout(H_para_layout4_3 );
//   ArmState_layout->addLayout(H_para_layout4_4 );
//   ArmState_layout->addLayout(H_para_layout4_5 );
//   ArmState_layout->addLayout(H_para_layout4_6 );
